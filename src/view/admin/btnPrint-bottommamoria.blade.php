<?php
$entryTable=$Amer->model->getTable();
...
<div class="dropdown" style="display: inline;">
    <button class="disabled bulk-button btn btn-sm btn-success dropdown-toggle" type="button" id="dropdownMenuButton1" data-bs-toggle="dropdown" aria-expanded="false">
    ...
    <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton1">
        <li>
            <a
                ...
                onclick="ShowprintMamoriaList(this,'{{url('api/v1/DriversApi/print')}}')"
                data-entry=""
                data-mdb-ripple-duration="0s"
                class="btn btn-sm btn-success dropdown-item bulk-button"
