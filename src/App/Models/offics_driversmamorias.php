...
use Carbon\Carbon;
class offics_driversmamorias extends Model
{
    ...
    */
    ...
    protected $table = 'offics_driversmamorias';
...
/*
    ...
    */
    ...
    function Drivers(){
        return $this->belongsTo(\Amerhendy\Drivers\App\Models\office_drivers::class,'driver_id','id')->withTrashed();
    }
    function Cars(){
        return $this->belongsTo(\Amerhendy\Drivers\App\Models\office_cars::class,'car_id','id')->withTrashed();
    }
    /*
    |--------------------------------------------------------------------------
    | SCOPES
    ...
    public function carOrNotToHtml(): Attribute
    {
        return new Attribute(
            get:function (mixed $value, array $attributes){
                ...
                return implode(' - ',array_unique(\Arr::map($cars,function($v,$k){return trans('ODLANG::MyOffice.carornot.types.'.$v);})));
            }
        );
    }
    /*
